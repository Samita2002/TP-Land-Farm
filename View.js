...
const trendCards = [
  ...
  { title: "อาหารฟังก์ชัน", description: "ผลิตภัณฑ์อินทรีย์ที่เพิ่มคุณค่าทางโภชนาการ", growth: "เติบโต +20% ต่อปี", gradient: "from-yellow-50 to-yellow-100", textColor: "text-yellow-600", icon: "❤️" },
];
